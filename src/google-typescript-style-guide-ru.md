...
Перевод основан на [версии оригинального руководства от ***10.11.2022***](https://github.com/google/styleguide/blob/fd8c54856d66df2e2643e048344ae04d2cfdde9a/tsguide.html).
...
Непустые группы операторов (`case ...`) *не должны* проваливаться (обеспечивается настройками компилятора[^comment-no-fallthrough-cases-in-switch]):
