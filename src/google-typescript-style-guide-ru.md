...
#### Пространства имен (namespace) & Именованные импорты

Могут использоваться как пространства имен, так и именованные импорты.

Именованный импорт предпочтителен для элементов, часто используемых в файле, а также для элементов, имеющих понятное название, как например, `describe` и `it` в Jasmine. При необходимости с помощью оператора `as` именованные импорты могут быть переименованы в более понятные названия.
